...
export const BestBuy: Store = {
  ...
  links: [
    ...
    {
      brand: 'xfx',
      cartUrl: 'https://api.bestbuy.com/click/-/6457624/cart',
      model: 'amd reference',
      series: 'rx6700xt',
      url: 'https://api.bestbuy.com/click/-/6457624/pdp',
    },
    {
      brand: 'xfx',
      cartUrl: 'https://api.bestbuy.com/click/-/6457626/cart',
      model: 'amd reference',
      series: 'rx6700xt',
      url: 'https://api.bestbuy.com/click/-/6457626/pdp',
    },
    {
      brand: 'xfx',
      cartUrl: 'https://api.bestbuy.com/click/-/6457620/cart',
      model: 'amd reference',
      series: 'rx6700xt',
      url: 'https://api.bestbuy.com/click/-/6457620/pdp',
    },
    {
      brand: 'xfx',
      cartUrl: 'https://api.bestbuy.com/click/-/6457622/cart',
      model: 'amd reference',
      series: 'rx6700xt',
      url: 'https://api.bestbuy.com/click/-/6457622/pdp',
    },
    {
      brand: 'xfx',
      cartUrl: 'https://api.bestbuy.com/click/-/6457619/cart',
      model: 'amd reference',
      series: 'rx6700xt',
      url: 'https://api.bestbuy.com/click/-/6457619/pdp',
    },
    {
      brand: 'msi',
      cartUrl: 'https://api.bestbuy.com/click/-/6457632/cart',
      model: 'amd reference',
      series: 'rx6700xt',
      url: 'https://api.bestbuy.com/click/-/6457632/pdp',
    },
    {
      brand: 'asus',
      cartUrl: 'https://api.bestbuy.com/click/-/6452573/cart',
      model: 'tuf',
      series: '3060ti',
      url: 'https://api.bestbuy.com/click/-/6452573/pdp',
    },
    {
      brand: 'gigabyte',
      cartUrl: 'https://api.bestbuy.com/click/-/6453897/cart',
      model: 'gaming oc',
      series: 'rx6800',
      url: 'https://api.bestbuy.com/click/-/6453897/pdp',
    },
  ],
  name: 'bestbuy',
};
